...
public class SpaceCamp {
    ...
    public static void SarsaλTrainer(int pNumActual, String oppStrat, int numEpisodes) {
        ...
        PersistentLinearVFA vfa = fd.generateVFA(0.0, pNumActual);
        GradientDescentSarsaLam sarsa = new GradientDescentSarsaLam(d, rf, tf, γ, vfa, learning_rate, 201, λ);
        ...
        for(int i = 0; i < numEpisodes; i++){
            ...
            if ( (10*i)%numEpisodes == 0) {
                ...
                vfa.saveToAsciiFile(SpaceInvaderFeatures.coeff_file + "p" + pNumActual + ".txt");
                vfa.saveToFile(SpaceInvaderFeatures.coeff_file + "p" + pNumActual + ".bin");
